...
const DataTable: React.FunctionComponent<IDataTableProps> = (props) => {
    ...
    const renderTableData = () => {
        return data.map((item) => { 
            return (
              <tr
                key={item._id}
                className="bg-gray-600 text-white border-b hover:bg-white hover:text-gray-900"
              >
                <td className="px6 py-3 break-words">
                  <Link
                    to={item.fullUrl}
                    target="_blank"
                ...
                <td className="px6 py-3">{item.clicks}</td>
                <td className="px6 py-3">
    ...
    return (
      <div className="container mx-auto pt-2 pb-10">
        <div className="relative overdflow-x-auto shadow-sm sm:rounded-lg">
